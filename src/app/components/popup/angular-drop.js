...
(function(angular) {
  ...
  angular.module('angularEffDrop', ['ng'])
  .provider('dropWrapper', function() {
    ...
    this.$get = function($rootScope, $compile, $templateCache) {
  ...
  .provider('effDropFactory', function() {
    /**
      ...
      return function(name, options) {
        return {
          ...
          link: function(scope, elem) {
             ...
             * Toggle the drop.
             */
            angular.element(elem).hover(function mouseenter() {
