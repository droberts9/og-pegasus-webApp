...
angular
  ...
  .provider('responsiveHelper', function ($windowProvider) {
    ...
    var helper   = {
      ...
      isMd: function () { return winWidth >= 768; },
 ...
 */
  .directive('arXs', function (responsiveHelper) {
    return {
      restrict    : "EAC",
      transclude  : 'element',
      template    : '<div></div>',
 ...
 */
  .directive('arSm', function (responsiveHelper) {
    return {
      restrict    : "EAC",
      transclude  : 'element',
      template    : '<div></div>',
 ...
 */
  .directive('arMd', function (responsiveHelper) {
    return {
      restrict    : "EAC",
      transclude  : 'element',
      template    : '<div></div>',
 ...
 */
  .directive('arLg', function (responsiveHelper) {
    return {
      restrict    : "EAC",
      transclude  : 'element',
      template    : '<div></div>',
 ...
 */
  .directive('arResponsive', function (responsiveHelper) {
    return {
      restrict    : "EAC",
      transclude  : 'element',
      template    : '<div></div>',
